...
class DoubleCurrencyPage extends StatefulWidget {
  const DoubleCurrencyPage({super.key});

  @override
  State<DoubleCurrencyPage> createState() => _DoubleCurrencyPageState();
}

class _DoubleCurrencyPageState extends State<DoubleCurrencyPage> {
  ...
  String selectedButton = '이중'; // 선택된 버튼
  // 첫번째 통화
  final _valueList = [
    '미국(달러) USD',
    '일본(엔) JPY',
