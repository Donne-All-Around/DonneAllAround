  ...
  Widget build(BuildContext context){
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          title : const Text('위치 정보 이용약관 동의',
          ...
          child: Expanded(
            child: Container(
              ...
              child: const Column(
                children: [
                  // 멘트
                  Text("위치기반 서비스 이용약관 동의\n총칙\n제1조(목적)\n본약관은 회원(돈네한바퀴서비스약관에 동의한 자를 말합니다."
                      " 이하‘회원’이라고 합니다) 이 돈네한바퀴(이하‘회사’라고합니다)가제공하는 돈네한바퀴서비스(돈네한바퀴 앱/웹 서비스,"
                      " 이하 포괄하여‘서비스’라고합니다)를이용함에있어회사와회원의권리·의무및책임사항을규정함을목적으로합니다."
